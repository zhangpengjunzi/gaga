...
public class GuessPayDetailsAdapter extends ListBaseAdapter<GuessPayDetailsModel.DataBean.ExchangeListBean> {


    public GuessPayDetailsAdapter(Context context) {
        super(context);
    }
    ...
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        final GuessPayDetailsModel.DataBean.ExchangeListBean exchangeListBean=mDataList.get(position);
        ...
        reason.setText(exchangeListBean.getReason());
        //底部线
